...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\RobertWilliamsIII\\RobertWilliamsIIIGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Robert Williams III get Over 7.0 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Robert Williams III will score over 7.0 points in today's game.")
else:
    print("The model predicts that Robert Williams III will score under 7.0 points in today's game.")