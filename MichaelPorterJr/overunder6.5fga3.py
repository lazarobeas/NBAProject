...
# Binarize the target variable based on the threshold of 5.5 FG3A
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Michael Porter Jr get Over 5.5 FG3A?')
plt.show()
...
today_game = {
    ...
    'PTS': 12.8,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Michael Porter Jr will score over 5.5 FG3A in today's game.")
else:
    print("The model predicts that Michael Porter Jr will score under 5.5 FG3A in today's game.")