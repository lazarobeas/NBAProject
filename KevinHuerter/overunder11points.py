...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\KevinHuerter\\KevinHuerterGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 11 points
y = y.apply(lambda x: 1 if x > 11 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Kevin Huerter get Over 11 points?')
plt.show()
...
today_game = {
    ...
    'FG3M': 0.8,  # Average made 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Kevin Huerter will score over 11 points in today's game.")
else:
    print("The model predicts that Kevin Huerter will score under 11 points in today's game.")