...
# Binarize the target variable based on the threshold of 9.0 Rebounds
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Jayson Tatum get Over 9.0 rebounds?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Jayson Tatum will score over 9.0 rebounds in today's game.")
else:
    print("The model predicts that Jayson Tatum will score under 9.0 rebounds in today's game.")
