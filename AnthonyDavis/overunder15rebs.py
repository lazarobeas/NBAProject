...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\AnthonyDavis\\AnthonyDavisGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 13.5 rebounds
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Anthony Davis get Over 13.5 rebounds?')
plt.show()
...
today_game = {
    ...
    'PTS': 20.6,   # Average rebounds
    'TOV': 2.2,   # Average turnovers
    'FG3M': 0.6,  # Average made 3-point field goals
    'FG3A': 1.8,  # Average attempted 3-point field goals
    'BLK': 3.8    # Average blocks
}
...
if today_game_prediction[0] == 1:
    print("The model predicts that Anthony Davis will score over 13.5 rebounds in today's game.")
else:
    print("The model predicts that Anthony Davis will score under 13.5 rebounds in today's game.")