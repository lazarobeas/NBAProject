...
# Binarize the target variable based on the threshold of 9.0 points
y = y.apply(lambda x: 1 if x > 9.0 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Clint Capela get Over 9.0 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Clint Capela will score over 9.0 points in today's game.")
else:
    print("The model predicts that Clint Capela will score under 9.0 points in today's game.")