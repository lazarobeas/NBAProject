...
# Binarize the target variable based on the threshold of 8.5 points
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Al Horford get Over 8.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Al Horford will score over 8.5 points in today's game.")
else:
    print("The model predicts that Al Horford will score under 8.5 points in today's game.")