...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\MitchellRobinson\\MitchellRobinsonGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 11.0 Rebounds
y = y.apply(lambda x: 1 if x > 11.0 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Mitchell Robinson get Over 11.0 Rebounds?')
plt.show()
...
today_game = {
    ...
    'AST': 1.0,   # Average assists
    'STL': 0.8,   # Average steals
    'PTS': 8.2,   # Average rebounds
    'TOV': 1.0,   # Average turnovers
    'FG3M': 0,  # Average made 3-point field goals
    'FG3A': 0,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Mitchell Robinson will score over 11.0 Rebounds in today's game.")
else:
    print("The model predicts that Mitchell Robinson will score under 11.0 Rebounds in today's game.")