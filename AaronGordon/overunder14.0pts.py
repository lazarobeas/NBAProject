...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\AaronGordon\\AaronGordonGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 14.0 points
y = y.apply(lambda x: 1 if x > 15.0 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Aaron Gordon get Over 15.0 points?')
plt.show()
...
today_game = {
    ...
    'STL': 0.7,   # Average steals
    'REB': 7.0,   # Average rebounds
    'TOV': 1.0,   # Average turnovers
    'FG3M': 1.2,  # Average made 3-point field goals
    'FG3A': 2.7,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Aaron Gordon will score over 15.0 points in today's game.")
else:
    print("The model predicts that Aaron Gordon will score under 15.0 points in today's game.")