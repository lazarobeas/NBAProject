...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Tobias Harris get Over 14.5 points?')
plt.show()
...
today_game = {
    ...
    'TOV': 0.2,   # Average turnovers
    'FG3M': 1.8,  # Average made 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Tobias Harris will score over 14.5 points in today's game.")
else:
    print("The model predicts that Tobias Harris will score under 14.5 points in today's game.")