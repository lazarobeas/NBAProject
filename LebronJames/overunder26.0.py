...
y = y.apply(lambda x: 1 if x > 26.0 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will LeBron James get Over 26.0 points?')
plt.show()
...
today_game = {
    ...
    'REB': 12.4,   # Average rebounds
    'TOV': 3.0,   # Average turnovers
    'FG3M': 1.2,  # Average made 3-point field goals
    'FG3A': 7.2,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that LeBron James will score over 26.0 points in today's game.")
else:
    print("The model predicts that LeBron James will score under 26.0 points in today's game.")