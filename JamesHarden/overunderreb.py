...
plt.ylabel('True')
plt.title('Confusion Matrix - Will James Harden get Over 6.0 rebounds?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that James Harden will score over 6.0 rebounds in today's game.")
else:
    print("The model predicts that James Harden will score under 6.0 rebounds in today's game.")