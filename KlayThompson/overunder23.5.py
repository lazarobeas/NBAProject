...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Klay Thompson get Over 23.0 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Klay Thompson will score over 23.0 points in today's game.")
else:
    print("The model predicts that Klay Thompson will score under 23.0 points in today's game.")