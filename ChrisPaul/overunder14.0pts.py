...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\ChrisPaul\\ChrisPaulGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Chris Paul get Over 4.5 points?')
plt.show()
...
today_game = {
    ...
    'PTS': 14.4,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Chris Paul will score over 14.0 points in today's game.")
else:
    print("The model predicts that Chris Paul will score under 14.0 points in today's game.")