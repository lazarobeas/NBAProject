...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\DeandreAyton\\DeandreAytonGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 16 points
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Deandre Ayton get Over 16 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Deandre Ayton will score over 16 points in today's game.")
else:
    print("The model predicts that Deandre Ayton will score under 16 points in today's game.")