...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\DejounteMurray\\DejounteMurrayGameEntireCareer.csv'
...
today_game = {
    ...
    'STL': 2,   # Average steals
    'REB': 6,   # Average rebounds
    'TOV': 2.2,   # Average turnovers
    'FG3M': 2.6,  # Average made 3-point field goals
    'FG3A': 7,  # Average attempted 3-point field goals
