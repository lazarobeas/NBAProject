...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Deandre Ayton get Over 15.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Deandre Ayton will score over 15.5 points in today's game.")
else:
    print("The model predicts that Deandre Ayton will score under 15.5 points in today's game.")