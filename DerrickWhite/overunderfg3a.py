...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\DerrickWhite\\DerrickWhiteGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 4.5 FG3A
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Derrick White get Over 4.5 FG3A?')
plt.show()
...
today_game = {
    ...
    'REB': 2.4,   # Average rebounds
    'TOV': 1.0,   # Average turnovers
    'FG3M': 2.0,  # Average made 3-point field goals
    'PTS': 12.4,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Derrick White will score over 4.5 FG3A in today's game.")
else:
    print("The model predicts that Derrick White will score under 4.5 FG3A in today's game.")