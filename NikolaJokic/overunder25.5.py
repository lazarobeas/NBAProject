...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Nikola Jokic get Over 25.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Nikola Jokic will score over 25.5 points in today's game.")
else:
    print("The model predicts that Nikola Jokic will score under 25.5 points in today's game.")