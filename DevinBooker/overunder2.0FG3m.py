...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\DevinBooker\\DevinBookerGameEntireCareer.csv'
...
if today_game_prediction[0] == 1:
    print("The model predicts that Devin Booker will score over 2.0 FG3M in today's game.")
else:
    print("The model predicts that Devin Booker will score under 2.0 FG3M in today's game.")