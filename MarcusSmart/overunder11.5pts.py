...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\MarcusSmart\\MarcusSmartGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Marcus Smart get Over 11.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Marcus Smart will score over 11.5 points in today's game.")
else:
    print("The model predicts that Marcus Smart will score under 11.5 points in today's game.")