...
# Binarize the target variable based on the threshold of 15.0 points
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Gabe Vincent get Over 15.0 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Gabe Vincent will score over 15.0 points in today's game.")
else:
    print("The model predicts that Gabe Vincent will score under 15.0 points in today's game.")