...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\KevinDurant\\KevinDurantGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 29.0 points
y = y.apply(lambda x: 1 if x > 29.0 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Kevin Durant get Over 29.0 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Kevin Durant will score over 29.0 points in today's game.")
else:
    print("The model predicts that Kevin Durant will score under 29.0 points in today's game.")