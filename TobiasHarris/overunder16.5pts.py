...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\TobiasHarris\\TobiasHarrisGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 16.5 points
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Tobias Harris get Over 16.5 points?')
plt.show()
...
today_game = {
    ...
    'REB': 8,   # Average rebounds
    'TOV': 0.4,   # Average turnovers
...
if today_game_prediction[0] == 1:
    print("The model predicts that Tobias Harris will score over 16.5 points in today's game.")
else:
    print("The model predicts that Tobias Harris will score under 16.5 points in today's game.")