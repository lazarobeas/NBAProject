...
capelaid = players.find_players_by_full_name("Jamal Murray")[0]['id']
...
df.to_csv('C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\JamalMurray\\JamalMurrayGameSplits22-23.csv')
