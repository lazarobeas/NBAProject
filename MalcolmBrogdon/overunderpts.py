...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\MalcolmBrogdon\\MalcolmBrogdonGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Malcolm Brogdon get Over 14.0 points?')
plt.show()
...
today_game = {
    ...
    'STL': 0,   # Average steals
    'REB': 2.6,   # Average rebounds
    'TOV': 1.2,   # Average turnovers
    'FG3M': 1.6,  # Average made 3-point field goals
    'FG3A': 4.8,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Malcolm Brogdon will score over 14.0 points in today's game.")
else:
    print("The model predicts that Malcolm Brogdon will score under 14.0 points in today's game.")