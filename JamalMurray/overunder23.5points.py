...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Jamal Murray get Over 24.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Jamal Murray will score over 24.5 points in today's game.")
else:
    print("The model predicts that Jamal Murray will score under 24.5 points in today's game.")