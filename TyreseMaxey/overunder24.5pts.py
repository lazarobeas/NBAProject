...
# Binarize the target variable based on the threshold of 20.5 points
y = y.apply(lambda x: 1 if x > 20.5 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Tyrese Maxey get Over 20.5 points?')
plt.show()
...
today_game = {
    ...
    'FG3A': 7.6,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Tyrese Maxey will score over 20.5 points in today's game.")
else:
    print("The model predicts that Tyrese Maxey will score under 20.5 points in today's game.")