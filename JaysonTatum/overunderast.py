...
features = ['HOME', 'PTS', 'STL', 'REB', 'TOV', 'FG3M', 'AST', 'BLK']
target = 'FG3A'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Jayson Tatum get Over 8.5 FG3A?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Jayson Tatum will score over 8.5 FG3A in today's game.")
else:
    print("The model predicts that Jayson Tatum will score under 8.5 FG3A in today's game.")
