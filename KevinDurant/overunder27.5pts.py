...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Kevin Durant get Over 28.5 points?')
plt.show()
...
today_game = {
    ...
    'TOV': 4.4,   # Average turnovers
    'FG3M': 1.8,  # Average made 3-point field goals
    'FG3A': 4.0,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Kevin Durant will score over 28.5 points in today's game.")
else:
    print("The model predicts that Kevin Durant will score under 28.5 points in today's game.")