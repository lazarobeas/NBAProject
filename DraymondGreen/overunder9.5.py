...
# Binarize the target variable based on the threshold of 9.5 points
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Draymond Green get Over 9.5 points?')
plt.show()
...
today_game = {
    ...
    'AST': 7.5,   # Average assists
    'STL': 2.3,   # Average steals
    'REB': 6.8,   # Average rebounds
    'TOV': 3.0,   # Average turnovers
    'FG3M': 0.5,  # Average made 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Draymond Green will score over 9.5 points in today's game.")
else:
    print("The model predicts that Draymond Green will score under 9.5 points in today's game.")