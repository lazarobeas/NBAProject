...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\TraeYoung\\TraeYoungGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 28 points
y = y.apply(lambda x: 1 if x > 28 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Trae Young get Over 28 points?')
plt.show()
...
today_game = {
    ...
    'AST': 10.2,   # Average assists
    'STL': 1.8,   # Average steals
    'REB': 3.8,   # Average rebounds
    'TOV': 3.8,   # Average turnovers
...
if today_game_prediction[0] == 1:
    print("The model predicts that Trae Young will score over 28 points in today's game.")
else:
    print("The model predicts that Trae Young will score 28 points or less in today's game.")
