...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Jayson Tatum get Over 9.5 rebounds?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Jayson Tatum will score over 9.5 rebounds in today's game.")
else:
    print("The model predicts that Jayson Tatum will score under 9.5 rebounds in today's game.")
