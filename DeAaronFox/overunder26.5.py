...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\DeAaronFox\\DeAaronFoxGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will DeAaron Fox get Over 26.5 points?')
plt.show()
...
today_game = {
    ...
    'REB': 9.2,   # Average rebounds
    'TOV': 3.0,   # Average turnovers
    'FG3M': 3.4,  # Average made 3-point field goals
    'FG3A': 10.0,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that DeAaron Fox will score over 26.5 points in today's game.")
else:
    print("The model predicts that DeAaron Fox will score under 26.5 points in today's game.")