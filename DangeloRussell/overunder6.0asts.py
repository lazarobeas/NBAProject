...
# Binarize the target variable based on the threshold of 6.0 assists
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Dangelo Russell get Over 6.0 assists?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Dangelo Russell will score over 6.0 assists in today's game.")
else:
    print("The model predicts that Dangelo Russell will score under 6.0 assists in today's game.")