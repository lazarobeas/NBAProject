...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\JarenJacksonJr\\JarenJacksonJrGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 18.5 points
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Jaren Jackson Jr get Over 18.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Jaren Jackson Jr will score over 18.5 points in today's game.")
else:
    print("The model predicts that Jaren Jackson Jr will score under 18.5 points in today's game.")