...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\MaxStrus\\MaxStrusGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Max Strus get Over 9.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Max Strus will score over 9.5 points in today's game.")
else:
    print("The model predicts that Max Strus will score under 9.5 points in today's game.")