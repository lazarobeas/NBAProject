...
features = ['HOME', 'PTS', 'STL', 'PTS', 'TOV', 'FG3M', 'FG3A', 'BLK']
target = 'AST'

X = data[features]
y = data[target]

# Binarize the target variable based on the threshold of 4.5 assists
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Jayson Tatum get Over 4.5 assists?')
plt.show()
...
today_game = {
    ...
    'PTS': 29.6,   # Average assists
    'STL': 0.8,   # Average steals
    'REB': 10.0,   # Average points
...
if today_game_prediction[0] == 1:
    print("The model predicts that Jayson Tatum will score over 4.5 assists in today's game.")
else:
    print("The model predicts that Jayson Tatum will score under 4.5 assists in today's game.")
