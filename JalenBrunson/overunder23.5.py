...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\JalenBrunson\\JalenBrunsonGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Jalen Brunson get Over 24.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Jalen Brunson will score over 24.5 points in today's game.")
else:
    print("The model predicts that Jalen Brunson will score under 24.5 points in today's game.")