...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\DesmondBane\\DesmondBaneGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 25.0 points
y = y.apply(lambda x: 1 if x > 25.0 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Desmond Bane get Over 25.0 points?')
plt.show()
...
today_game = {
    ...
    'AST': 3.4,   # Average assists
    'STL': 0.4,   # Average steals
    'REB': 6.2,   # Average rebounds
    'TOV': 3.0,   # Average turnovers
    'FG3M': 2.8,  # Average made 3-point field goals
    'FG3A': 8.8,  # Average attempted 3-point field goals
    'BLK': 0    # Average blocks
}
...
if today_game_prediction[0] == 1:
    print("The model predicts that Desmond Bane will score over 25.0 points in today's game.")
else:
    print("The model predicts that Desmond Bane will score under 25.0 points in today's game.")