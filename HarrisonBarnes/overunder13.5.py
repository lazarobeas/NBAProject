...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\HarrisonBarnes\\HarrisonBarnesGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 11.5 points
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Harrison Barnes get Over 11.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Harrison Barnes will score over 11.5 points in today's game.")
else:
    print("The model predicts that Harrison Barnes will score under 11.5 points in today's game.")