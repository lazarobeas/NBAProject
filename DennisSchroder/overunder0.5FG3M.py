...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\DennisSchroder\\DennisSchroderGameEntireCareer.csv'
...
features = ['HOME', 'AST', 'STL', 'REB', 'TOV', 'PTS', 'FG3A', 'BLK']
target = 'FG3M'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Dennis Schroder get over 0.5 FG3M?')
plt.show()
...
today_game = {
    ...
    'REB': 1.4,   # Average rebounds
    'TOV': 1.4,   # Average turnovers
    'PTS': 4.2,  # Average made 3-point field goals
    'FG3A': 1.2,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Dennis Schroder will score over 0.5 FG3M in today's game.")
else:
    print("The model predicts that Dennis Schroder will score under 0.5 FG3M in today's game.")