...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\JaMorant\\JaMorantGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Ja Morant get Over 28.5 points?')
plt.show()
...
today_game = {
    ...
    'AST': 7.3,   # Average assists
    'STL': 1.5,   # Average steals
    'REB': 7.3,   # Average rebounds
    'TOV': 3.8,   # Average turnovers
    'FG3M': 2.8,  # Average made 3-point field goals
    'FG3A': 6.0,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Ja Morant will score over 28.5 points in today's game.")
else:
    print("The model predicts that Ja Morant will score under 28.5 points in today's game.")