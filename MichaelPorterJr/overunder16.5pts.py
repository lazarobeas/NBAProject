...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Michael Porter Jr get Over 16.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that Michael Porter Jr will score over 16.5 points in today's game.")
else:
    print("The model predicts that Michael Porter Jr will score under 16.5 points in today's game.")