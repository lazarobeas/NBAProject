...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Joel Embiid get Over 25.5 points?')
plt.show()
...
today_game = {
    ...
    'FG3A': 2.4,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Joel Embiid will score over 25.5 points in today's game.")
else:
    print("The model predicts that Joel Embiid will score under 25.5 points in today's game.")