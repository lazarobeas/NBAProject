...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\KentaviousCaldwellPope\\KentaviousCaldwellPopeGameEntireCareer.csv'
...
# Binarize the target variable based on the threshold of 10.5 points
y = y.apply(lambda x: 1 if x > 10.5 else 0)
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Kentavious Caldwell-Pope get Over 10.5 points?')
plt.show()
...
today_game = {
    ...
    'REB': 3.4,   # Average rebounds
    'TOV': 0.8,   # Average turnovers
    'FG3M': 5.8,  # Average made 3-point field goals
    'FG3A': 11.2,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Kentavious Caldwell-Pope will score over 10.5 points in today's game.")
else:
    print("The model predicts that Kentavious Caldwell-Pope will score under 10.5 points in today's game.")