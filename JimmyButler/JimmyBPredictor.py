...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\JimmyButler\\JimmyButlerGameEntireCareer.csv'
...
print("Enter Jimmy Butler's stats for the last 5 games:\n")
today_game = {
