...
plt.ylabel('True')
plt.title(f'Confusion Matrix - Gabe Vincent Simulated with {point_threshold} points')
plt.show()

# Input the feature values for today's game
print("Enter Gabe Vincent's stats for last 5 games:\n")
today_game = {
...
if today_game_prediction[0] == 1:
    print(f"\nThe model predicts that Gabe Vincent will score over {point_threshold} points in today's game.")
else:
    print(f"\nThe model predicts that Gabe Vincent will score under {point_threshold} points in today's game.")