...
filepath = 'C:\\Users\\Lazaro B\\Documents\\GitHub\\NBAProject\\data\\RJBarrett\\RJBarrettGameEntireCareer.csv'
...
plt.ylabel('True')
plt.title('Confusion Matrix - Will RJ Barrett get Over 21.5 points?')
plt.show()
...
if today_game_prediction[0] == 1:
    print("The model predicts that RJ Barrett will score over 21.5 points in today's game.")
else:
    print("The model predicts that RJ Barrett will score under 21.5 points in today's game.")