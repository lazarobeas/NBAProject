...
plt.ylabel('True')
plt.title('Confusion Matrix - Will Dennis Schroder get over 8.5 points?')
plt.show()
...
today_game = {
    ...
    'FG3A': 1.4,  # Average attempted 3-point field goals
...
if today_game_prediction[0] == 1:
    print("The model predicts that Dennis Schroder will score over 8.5 points in today's game.")
else:
    print("The model predicts that Dennis Schroder will score under 8.5 points in today's game.")